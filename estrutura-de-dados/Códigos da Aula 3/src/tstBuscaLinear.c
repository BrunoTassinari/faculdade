...
int tst_chave_qualquer() {
  ...
  int indice = busca_linear(vetor, TAMANHO, chave_qualquer);
...
int tst_chave_inexistente() {
  ...
  int indice = busca_linear(vetor, TAMANHO, chave_inexistente);
...
int tst_chave_negativa() {
  ...
  int indice = busca_linear(vetor, TAMANHO, chave_negativa);
  int encontrou = (indice != NAO_ENCONTRADO);
